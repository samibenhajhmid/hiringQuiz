...
module.exports = function(XRegExp) {
    ...
    XRegExp.addToken(
        ...
        function(match, scope, flags) {
            ...
            var ERR_ASTRAL_IN_CLASS = 'Astral mode does not support Unicode tokens within character interfaces';
            // Negated via \P{..} or \p{^..}
     ...
     *   character interfaces and alternation, and should use surrogate pairs to represent astral code
